...
- [4. Key Findings Summary](#4-key-findings-summary)
  - [Cơ chế Vật lý](#1-cơ-chế-vật-lý)
  - [Kỹ thuật Dữ liệu: MICE chiến thắng PCA](#2-kỹ-thuật-dữ-liệu-mice-chiến-thắng-pca)
  - [Hiệu năng Mô hình: XGBoost và bài toán đánh đổi](#3-hiệu-năng-mô-hình-xgboost-và-bài-toán-đánh-đổi)
